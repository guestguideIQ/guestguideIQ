// Illustrative hyperlocal picks: the kind of recommendation GuestGuideIQ
// curates into a host's guide. A concept showcase, not live inventory (see
// docs/SPEC.md §6.3). Shared by the Home preview and /experiences/.
